...
pub(crate) const CUBE_CORNER_ORIENTATION_INDEX_COUNT: usize = 2187; // 3**7
pub(crate) const CUBE_CORNER_PERMUTATION_INDEX_COUNT: usize = 40320; // 8!

pub(crate) const CUBE3_EDGE_ORIENTATION_INDEX_COUNT: usize = 2048; // 2**11
pub(crate) const CUBE3_PHASE_2_EDGE_PERMUTATION_INDEX_COUNT: usize = 40320; // 8!
pub(crate) const CUBE3_EDGE_SLICE_INDEX_COUNT: usize = crate::common::n_choose_k(12, 4);
pub(crate) const CUBE3_PHASE_2_EQUATORIAL_EDGE_PERMUTATION_INDEX_COUNT: usize = 24; // 4!
...
pub(crate) const CUBE4_PHASE_4_EDGE_PAIR_INDEX_COUNT: usize = 40320; // 8!
