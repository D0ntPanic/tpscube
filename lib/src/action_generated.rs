...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_PENALTY: u8 = 4;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_PENALTY: [Penalty; 5] = [
  Penalty::NONE,
  Penalty::TimePenalty,
  Penalty::DNFPenalty,
  Penalty::RecognitionDNFPenalty,
  Penalty::ExecutionDNFPenalty,
];
...
impl Penalty {
  ...
  pub const RecognitionDNFPenalty: Self = Self(3);
  pub const ExecutionDNFPenalty: Self = Self(4);
  ...
  pub const ENUM_VALUES: &'static [Self] = &[
    ...
    Self::TimePenalty,
    Self::DNFPenalty,
    Self::RecognitionDNFPenalty,
    Self::ExecutionDNFPenalty,
  ];
  ...
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      ...
      Self::RecognitionDNFPenalty => Some("RecognitionDNFPenalty"),
      Self::ExecutionDNFPenalty => Some("ExecutionDNFPenalty"),
      _ => None,
    }
  }
}
impl core::fmt::Debug for Penalty {
...
impl core::fmt::Debug for ActionContents {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    if let Some(name) = self.variant_name() {
      f.write_str(name)
    } else {
...
impl core::fmt::Debug for TimedMove {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
...
impl<'b> flatbuffers::Push for TimedMove {
    ...
    fn push(&self, dst: &mut [u8], _rest: &[u8]) {
        let src = unsafe {
            ::core::slice::from_raw_parts(self as *const TimedMove as *const u8, Self::size())
        };
...
impl<'a> TimePenalty<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    args: &'args TimePenaltyArgs
  ) -> flatbuffers::WIPOffset<TimePenalty<'bldr>> {
...
impl core::fmt::Debug for TimePenalty<'_> {
...
impl<'a> DNFPenalty<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    _args: &'args DNFPenaltyArgs
  ) -> flatbuffers::WIPOffset<DNFPenalty<'bldr>> {
...
impl core::fmt::Debug for DNFPenalty<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("DNFPenalty");
      ds.finish()
  }
}
pub enum RecognitionDNFPenaltyOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct RecognitionDNFPenalty<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for RecognitionDNFPenalty<'a> {
  type Inner = RecognitionDNFPenalty<'a>;
  #[inline]
  fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table { buf, loc } }
  }
...
impl<'a> RecognitionDNFPenalty<'a> {

  #[inline]
  pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    RecognitionDNFPenalty { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    _args: &'args RecognitionDNFPenaltyArgs
  ) -> flatbuffers::WIPOffset<RecognitionDNFPenalty<'bldr>> {
    let mut builder = RecognitionDNFPenaltyBuilder::new(_fbb);
    builder.finish()
  }

}

impl flatbuffers::Verifiable for RecognitionDNFPenalty<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
pub struct RecognitionDNFPenaltyArgs {
}
impl<'a> Default for RecognitionDNFPenaltyArgs {
  #[inline]
  fn default() -> Self {
    RecognitionDNFPenaltyArgs {
    }
  }
}

pub struct RecognitionDNFPenaltyBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> RecognitionDNFPenaltyBuilder<'a, 'b> {
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> RecognitionDNFPenaltyBuilder<'a, 'b> {
    let start = _fbb.start_table();
    RecognitionDNFPenaltyBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<RecognitionDNFPenalty<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for RecognitionDNFPenalty<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("RecognitionDNFPenalty");
      ds.finish()
  }
}
pub enum ExecutionDNFPenaltyOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct ExecutionDNFPenalty<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for ExecutionDNFPenalty<'a> {
  type Inner = ExecutionDNFPenalty<'a>;
  #[inline]
  fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table { buf, loc } }
  }
...
impl<'a> ExecutionDNFPenalty<'a> {

  #[inline]
  pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    ExecutionDNFPenalty { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    _args: &'args ExecutionDNFPenaltyArgs
  ) -> flatbuffers::WIPOffset<ExecutionDNFPenalty<'bldr>> {
    let mut builder = ExecutionDNFPenaltyBuilder::new(_fbb);
    builder.finish()
  }

}

impl flatbuffers::Verifiable for ExecutionDNFPenalty<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
pub struct ExecutionDNFPenaltyArgs {
}
impl<'a> Default for ExecutionDNFPenaltyArgs {
  #[inline]
  fn default() -> Self {
    ExecutionDNFPenaltyArgs {
    }
  }
}

pub struct ExecutionDNFPenaltyBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> ExecutionDNFPenaltyBuilder<'a, 'b> {
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> ExecutionDNFPenaltyBuilder<'a, 'b> {
    let start = _fbb.start_table();
    ExecutionDNFPenaltyBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<ExecutionDNFPenalty<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for ExecutionDNFPenalty<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("ExecutionDNFPenalty");
      ds.finish()
  }
}
...
impl<'a> NewSolveAction<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args NewSolveActionArgs<'args>
  ) -> flatbuffers::WIPOffset<NewSolveAction<'bldr>> {
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn penalty_as_recognition_dnfpenalty(&self) -> Option<RecognitionDNFPenalty<'a>> {
    if self.penalty_type() == Penalty::RecognitionDNFPenalty {
      self.penalty().map(RecognitionDNFPenalty::init_from_table)
    } else {
      None
    }
  }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn penalty_as_execution_dnfpenalty(&self) -> Option<ExecutionDNFPenalty<'a>> {
    if self.penalty_type() == Penalty::ExecutionDNFPenalty {
      self.penalty().map(ExecutionDNFPenalty::init_from_table)
    } else {
      None
    }
  }
    ...
    v.visit_table(pos)?
     ...
     .visit_union::<Penalty, _>("penalty_type", Self::VT_PENALTY_TYPE, "penalty", Self::VT_PENALTY, false, |key, v, pos| {
        match key {
          ...
          Penalty::RecognitionDNFPenalty => v.verify_union_variant::<flatbuffers::ForwardsUOffset<RecognitionDNFPenalty>>("Penalty::RecognitionDNFPenalty", pos),
          Penalty::ExecutionDNFPenalty => v.verify_union_variant::<flatbuffers::ForwardsUOffset<ExecutionDNFPenalty>>("Penalty::ExecutionDNFPenalty", pos),
          _ => Ok(()),
        }
     })?
...
impl core::fmt::Debug for NewSolveAction<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("NewSolveAction");
      ...
      match self.penalty_type() {
        ...
        Penalty::RecognitionDNFPenalty => {
          if let Some(x) = self.penalty_as_recognition_dnfpenalty() {
            ds.field("penalty", &x)
          } else {
            ds.field("penalty", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        Penalty::ExecutionDNFPenalty => {
          if let Some(x) = self.penalty_as_execution_dnfpenalty() {
            ds.field("penalty", &x)
          } else {
            ds.field("penalty", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
...
impl<'a> PenaltyAction<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args PenaltyActionArgs<'args>
  ) -> flatbuffers::WIPOffset<PenaltyAction<'bldr>> {
...
impl core::fmt::Debug for PenaltyAction<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
...
impl<'a> ChangeSessionAction<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args ChangeSessionActionArgs<'args>
  ) -> flatbuffers::WIPOffset<ChangeSessionAction<'bldr>> {
...
impl core::fmt::Debug for ChangeSessionAction<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
...
impl<'a> MergeSessionsAction<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args MergeSessionsActionArgs<'args>
  ) -> flatbuffers::WIPOffset<MergeSessionsAction<'bldr>> {
...
impl core::fmt::Debug for MergeSessionsAction<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
...
impl<'a> RenameSessionAction<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args RenameSessionActionArgs<'args>
  ) -> flatbuffers::WIPOffset<RenameSessionAction<'bldr>> {
...
impl core::fmt::Debug for RenameSessionAction<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
...
impl<'a> DeleteSolveAction<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args DeleteSolveActionArgs<'args>
  ) -> flatbuffers::WIPOffset<DeleteSolveAction<'bldr>> {
...
impl core::fmt::Debug for DeleteSolveAction<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
...
impl<'a> ActionList<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args ActionListArgs<'args>
  ) -> flatbuffers::WIPOffset<ActionList<'bldr>> {
...
impl core::fmt::Debug for ActionList<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
